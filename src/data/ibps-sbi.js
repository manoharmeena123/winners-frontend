...
export const ibpsRrbExamData = {
  ...
  prelimsSyllabus: {
    ...
    tableTitle: "PRELIMS",
    examData: [
      { id: 2, section: "Maths", questions: 40, marks: 40 },
      { id: 3, section: "Reasoning", questions: 40, marks: 40 },
    ],
    totalQuestions: 80,
    totalMarks: 80,
  },
    ...
    tableData: [
      {
        ...
        topics: [
          ...
          "Percentages",
          "Ratio & Proportion",
          "Averages", // Removed duplicate entry
      ...
      },
      {
        ...
        topics: [
          ...
          "Seating Arrangement: Direction-based",
          "Seating Arrangement: MISC",
          "Number Series",
          "Odd man out",
          "Coding-Decoding",
          "Blood Relation",
  ...
  syllabusData2: {
    ...
    tableData: [
      ...
      {
        section: "English/Hindi Language",
        topics: [
