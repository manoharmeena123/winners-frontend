...
const IBPSCLERK = () => {
  ...
  const { title, intro, content, officialWebsite } = ibpsSbiClerkData;
  ...
  return (
    <>
      <Header />
      <ReactHelmet
        title="IBPS Clerk & SBI Clerk - The WiNNERS Institute"
        ...
        <div className="container mx-auto max-w-[1166px] mx-auto lg:px-6 sm:px-0 py-4 mt-[82px] relative">
          ...
          <nav className="text-sm mb-4" aria-label="Breadcrumb">
            <ol className="list-none p-0 inline-flex">
              ...
              <li>
                <span className="text-gray-500">IBPS Clerk & SBI Clerk</span>
              </li>
            </ol>
          </nav>
