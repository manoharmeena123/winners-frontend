  ...
  const SubmitTheForm = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${Api_Url}/api/admin/AddJabalpurSeminar`,
        newFormData,
        {
          headers: {
  ...
  const updatestatus = async (id) => {
    try {
      const response = await PutApi(
        `api/admin/updatejabalpurseminarPaymentStatus/${id}`,
        {}
      );
  ...
  const Sendmail = async (id) => {
    try {
      const response = await GetApi(
        `api/admin/sendJabalpurMailregistration/${id}`
      );
  ...
  const deleteresponse = async (id) => {
    try {
      const response = await DeleteApi(
        `api/admin/DeleteSingleJabalpurFormdata/${id}`,
        {}
      );
      console.log(response.data);
    } catch (error) {
...
export default JabalpurSeminarform;
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div className="bg-white rounded-lg shadow-lg md:w-1/3 w-4/5">
...
function OtpInputModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-lg shadow-lg md:w-1/3 w-4/5">
