...
import {
  ...
  smallScreenBooks,
  largeScreenBooks,
} from "../../data/rrb-technician";
import Card from "../../components/card/Card";
import RelatedPost from "../../components/sidebar/RelatedPost";

const RailwayALP = () => {
  const { title, intro, content, officialWebsite } = rrbTechnicianData;
      ...
      <div className="container mx-auto max-w-[1166px] mx-auto lg:px-6 sm:px-0 py-4 mt-[82px] relative">
        ...
        <nav className="text-sm mb-4" aria-label="Breadcrumb">
          <ol className="list-none p-0 inline-flex">
            ...
            <li>
              <span className="text-gray-500">RRB-Technician</span>
            </li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
          ...
          <div className="md:col-span-9">
            ...
            {/*RRB Technician 2025 Notification Released */}
            <div
            ...
            {/* RRB Technician Age Limit and Relaxation */}
            <div
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc ml-6">
                  <li>
                    ...
                    <strong>
                      {
                        railwayTechnicianData?.notificationData.ageLimit.general
                          .min
                      }{" "}
                      years
                    </strong>
            ...
            >
              ...
              >
                ...
                <div id="railway-alp-cbt-ii" className="mt-6">
                  ...
                  {/* Note Section */}
                  <div className="bg-gray-50 border border-gray-300 rounded-md p-4 mt-4 shadow-md">
                    <h3 className="text-lg font-bold text-gray-800 mb-2">
                      Important Information
                    </h3>
                    <ul className="list-disc list-inside text-gray-700">
                      <li>
                        <strong>Age Limit:</strong> 18-33 Years
                      </li>
                      <li>
                        <strong>Qualification Required:</strong> 10+2 PCM / ITI
                      </li>
                      <li>
                        <strong>Pattern of Exam:</strong> Objective Type (CBT)
                      </li>
                      <li className="text-red-600">
                        <strong>Note:</strong> There will be negative marking of
                  ...
                  <div className="overflow-x-auto mt-4">
                    ...
                    <div className="overflow-x-auto">
                      <table className="table-auto w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                          {railwayTechnicianData?.syllabusData?.cbtData?.map(
                            (item, index) => (
                              <tr
                                key={index}
                                className={
                              ...
                              >
                                ...
                                {index === 0 && (
                                  <td
                                    ...
                                    rowSpan={
                                      railwayTechnicianData?.syllabusData
                                        ?.cbt1examData?.tableData?.length -1
                                    }
                                  >
                                    {
                                      railwayTechnicianData?.syllabusData
                  ...
                  <div className="mt-4">
                    {railwayTechnicianData?.syllabusData?.sectionsB.map(
                      (section, index) => (
                        <div key={index} className="mb-4">
                          <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                            {section.name}
