        ...
        <div className="container mx-auto max-w-[1166px] mx-auto lg:px-6 sm:px-0 py-4 mt-[82px] relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
            ...
            <div className="md:col-span-9">
                ...
                <div className="mb-6">
                  ...
                  <ul className="list-disc ml-6">
                    <li>
                      ...
                      <strong>
                        {
                          mpWomenSupervisorExamData?.notificationData.ageLimit
                            .min
                        }{" "}
                        years
                      </strong>
              ...
              <div className="bg-white shadow-md rounded-md p-6 mt-6">
                <h2 className="lg:text-2xl sm:text-xl font-bold text-gray-800 mb-4">
                  Third Section - Managerial Skills ( तृतीय खंड - प्रबंधकीय
                  गुण:-)
                </h2>
                <div className="overflow-x-auto">
                  <table className="table-auto w-full">
              ...
              <div className="bg-white shadow-md rounded-md p-6 mt-6">
                <h2 className="lg:text-2xl sm:text-xl font-bold text-gray-800 mb-4">
                  Fourth Section - Early Childhood Care and Education ( चतुर्थ
                  खंड - शिशु की प्रारम्भिक देखभाल एवं शिक्षा:-)
                </h2>
                <div className="overflow-x-auto">
                  <table className="table-auto w-full">
                    <thead>
