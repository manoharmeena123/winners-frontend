  ...
  return (
    <>
      ...
      <DynamicModalWrapper
        ...
        centerImage="https://appx-content-v2.classx.co.in/paid_course3/2025-01-07-0.5290580054627592.jpeg"
        centerlink="https://live.winnersinstitute.in/courses/464-mptet-varg-3-online-course-tet3se1224"
        ...
        <div className="container mx-auto max-w-[1166px] mx-auto lg:px-6 sm:px-0 py-4 mt-[82px] relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
            ...
            <div className="md:col-span-9">
                ...
                <div className="mb-6">
                  ...
                  <ul className="list-disc ml-6">
                    <li>
                      Minimum Age:{" "}
                      <strong>
                        {mpConstableExamData?.notificationData.ageLimit.min}{" "}
                        years
                      </strong>
                    </li>
                    <li>
                      Maximum Age:{" "}
                      <strong>
                        {mpConstableExamData?.notificationData.ageLimit.max}{" "}
                        years
                      </strong>
                    </li>
                    <li>
              ...
              <div
                id="mp-constable-physical-test-2025"
                className="bg-white shadow-md rounded-md p-6 mt-6"
              >
                <h2 className="lg:text-2xl sm:text-xl font-bold text-gray-800 mb-4">
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      ...
                      <tr className="font-bold bg-gray-200">
                        ...
                        <td className="border border-gray-300 px-4 py-2">
                          {mpConstableExamData?.syllabus?.tableData.length *
                            120}{" "}
                          मिनट
                        </td>
                      </tr>
